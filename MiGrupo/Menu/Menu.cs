...
namespace AlumnoEjemplos.MiGrupo
{
    public class Menu
    {
        ...
        public void setHeader()
        {
            ...
            this.header.Texture = TgcTexture.createTexture(EjemploAlumno.mediaFolder + "menu\\RocketLeague.png"); 
            this.header.Scaling = new Vector2(0.5f,0.5f);
            this.header.Position = new Vector2(
                (GuiController.Instance.Panel3d.Size.Width - this.header.Texture.Width/2) / 2, 15 );
        }
